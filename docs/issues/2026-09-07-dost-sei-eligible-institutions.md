...
1. CCDO decides two policy points: accept LUCs per the Helpdesk FAQ or hold to the brochure; and whether teacher-ed-only private HEIs belong in the dropdown (they are placements for BSEd Science/Math scholars only).
