...
insert into public.applications
  (id, term_id, status, applicant_email, applicant_given_name, applicant_family_name,
   payload, proof_drive_file_id, submit_token_hash, submit_token_expires_at)
values
  ...
  ('00000000-0000-4000-8000-000000000101', pg_temp.fx_active_term(), 'draft',
   ...
   encode(sha256(convert_to('tok-alpha-happy', 'UTF8')), 'hex'), now() + interval '1 hour'),
  ...
  ('00000000-0000-4000-8000-000000000102', pg_temp.fx_active_term(), 'draft',
   ...
   encode(sha256(convert_to('tok-bravo-validation', 'UTF8')), 'hex'), now() + interval '1 hour'),
  ...
  ('00000000-0000-4000-8000-000000000103', pg_temp.fx_active_term(), 'draft',
   ...
   encode(sha256(convert_to('tok-charlie-expired', 'UTF8')), 'hex'), now() - interval '1 hour'),
  ...
  ('00000000-0000-4000-8000-000000000104', pg_temp.fx_active_term(), 'draft',
   ...
   encode(sha256(convert_to('tok-delta-duplicate', 'UTF8')), 'hex'), now() + interval '1 hour'),
  ...
  ('00000000-0000-4000-8000-000000000105', pg_temp.fx_active_term(), 'rejected',
   ...
   encode(sha256(convert_to('tok-echo-decided', 'UTF8')), 'hex'), now() + interval '1 hour');
